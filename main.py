"""
Modulos necesarios para el funcionamiento de la aplicación.
"""
...
class Aplicacion:
    """	
	Clase principal de la aplicación que inicializa los controles y las pantallas.
	"""
    def __init__(self):
        """
        ...
        self.control_gastos = ControlGastos(self.repo_viajes)
